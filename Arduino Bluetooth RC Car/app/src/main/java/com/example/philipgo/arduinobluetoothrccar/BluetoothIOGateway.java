...
public class BluetoothIOGateway
{
    ...
    private synchronized void setState(int state)
    {
        ...
        mHandler.obtainMessage(BTMainActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType)
    {
        ...
        Message msg = mHandler.obtainMessage(BTMainActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BTMainActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed()
    {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BTMainActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost()
    {
        ...
        Message msg = mHandler.obtainMessage(BTMainActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BTMainActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread
    {
        ...
        public void run()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    mHandler.obtainMessage(BTMainActivity.MESSAGE_READ, bytes, -1, buffer).sendToTarget();
                }
                catch (IOException e)
                {
        ...
        public void write(byte[] buffer)
        {
            try
            {
                ...
                mHandler.obtainMessage(BTMainActivity.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
            }
            catch (IOException e)
            {
